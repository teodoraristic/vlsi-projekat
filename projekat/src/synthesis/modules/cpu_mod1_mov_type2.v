// MOV Type 2: ako Zo == 1000, mem[X] = C (konstanta iz druge reci instrukcije)
// Format: 0000 XXXX ???? 1000 | C15..C0
...
module cpu #(
    ...
    // Konstanta iz druge reci (ir_out[31:16])
    ...
    always @(*) begin
        ...
        case (state_q)
            ...
            // MOV Type 2 (Zo==1000) je dvorecan -> ide na S_FETCH_MAR_2
            // Sve ostale poznate instrukcije su jednoreche
            S_DECODE: begin
                if (opcode == OP_MOV && Zo == 4'b1000)
            ...
            S_EAY_DONE: begin
                ...
                if (opcode==OP_MOV && Zo==4'b0000) begin
                    // Originalni MOV: mem[X] = mem[Y]
                    state_d = S_RDY_MAR;
                end else if (opcode==OP_MOV && Zo==4'b1000) begin
                    // MOV Type 2: mem[X] = konstanta iz druge reci
                    state_d = S_MOVI_WB;
            ...
            // MOV Type 2: upiši konstantu iz druge reci na adresu X
            S_MOVI_WB: begin
                we_d     = 1'b1;
                data_d   = ir_const;
                mar_ld_d = 1'b1;
